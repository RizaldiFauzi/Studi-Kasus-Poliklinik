...
<body>
    ...
    <div class="container">
        ...
        <!--Form Input Data-->
                ...
                <form class="form row" method="POST" action="pasien.php" name="myForm" onsubmit="return(validate());">
                    ...
                    <div class="col">
                        ...
                        <input type="varchar" class="form-control" name="nama" id="nama" placeholder="Pasien" value="<?php echo $nama ?>">
                    </div>
                    <div class="col">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger rounded-pill px-3" href="pasien.php?id=<?php echo $data['id'] ?>&aksi=hapus">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            }
                ...
                if (isset($_POST['simpan'])) {
                    if (isset($_POST['id'])) {
                      ...
                      $alamat = $_POST['alamat'];
                      $no_hp = $_POST['no_hp'];
                      $tambah = mysqli_query($mysqli, "INSERT INTO pasien(nama, alamat, no_hp) VALUES('$nama', '$alamat', '$no_hp')");
                    }
